...
class ScriptInjectionSubscriber implements EventSubscriberInterface
{
    ...
    {
        // Temporarily disabled until we can resolve the template injection method
        return;
        ...
        if (strpos($uri, 'plugins/config/LodgeSubscription') !== false && 
            ...
            // TODO: Fix template injection - need to find correct method for CustomTemplateEvent
            // This was causing issues with setContent() and addTemplate() methods
        }
    }
} 